...
export enum CompetitionApiApiKeys {
    ApiKeyAuth,
}
...
export class CompetitionApi {
    ...
    public setApiKey(key: CompetitionApiApiKeys, value: string) {
        (this.authentications as any)[CompetitionApiApiKeys[key]].apiKey = value;
    }
