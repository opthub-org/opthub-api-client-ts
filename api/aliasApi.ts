...
export class AliasApi {
    ...
    public setApiKey(key: AliasApiApiKeys, value: string) {
        (this.authentications as any)[AliasApiApiKeys[key]].apiKey = value;
    }
    ...
    public async resolveCompetitionAliasById (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling resolveCompetitionAliasById.');
        }
    ...
    public async resolveCompetitionIdByAlias (alias: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        ...
        if (alias === null || alias === undefined) {
            throw new Error('Required parameter alias was null or undefined when calling resolveCompetitionIdByAlias.');
        }
