...
export enum SolutionApiApiKeys {
    ApiKeyAuth,
}
...
export class SolutionApi {
    ...
    public setApiKey(key: SolutionApiApiKeys, value: string) {
        (this.authentications as any)[SolutionApiApiKeys[key]].apiKey = value;
    }
    ...
    public async createSolution (matchId: string, variable: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CreateSolutionResponse;  }> {
        ...
        if (matchId === null || matchId === undefined) {
            throw new Error('Required parameter matchId was null or undefined when calling createSolution.');
        }

        // verify required parameter 'variable' is not null or undefined
        if (variable === null || variable === undefined) {
            throw new Error('Required parameter variable was null or undefined when calling createSolution.');
        }

        if (matchId !== undefined) {
            localVarQueryParameters['matchId'] = ObjectSerializer.serialize(matchId, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CreateSolutionResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "CreateSolutionResponse");
    ...
    public async getSolution (matchId: string, participantId: string, trialNo: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Solution;  }> {
        ...
        // verify required parameter 'matchId' is not null or undefined
        if (matchId === null || matchId === undefined) {
            throw new Error('Required parameter matchId was null or undefined when calling getSolution.');
        }

        // verify required parameter 'participantId' is not null or undefined
        if (participantId === null || participantId === undefined) {
            throw new Error('Required parameter participantId was null or undefined when calling getSolution.');
        }
        ...
        if (trialNo !== undefined) {
            localVarQueryParameters['trialNo'] = ObjectSerializer.serialize(trialNo, "number");
        }
